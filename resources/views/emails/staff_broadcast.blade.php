...
@section('content')
    ...
    <p class="body-text text-primary" style="margin: 0 0 24px 0; font-size: 17px; line-height: 1.47; color: #1d1d1f; white-space: pre-wrap;">{{ $notification->body }}</p>
...
--}}
@section('footer_note')
    Don't want these emails? <a href="{{ $unsubscribeUrl }}" style="color:#86868b; text-decoration:underline;">Unsubscribe</a>
@endsection
