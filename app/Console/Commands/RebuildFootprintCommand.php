...
class RebuildFootprintCommand extends Command
{
    ...
    private const NEW_PATHS = [
        ...
        'schema (new migrations)' => [
            ...
            'supabase/migrations/20260727110001_connections_surface_key_backfill.sql',
            'supabase/migrations/20260727110002_connections_surface_key_constraints_not_valid.sql',
            'supabase/migrations/20260727110003_connections_surface_key_validate_and_not_null.sql',
            'supabase/migrations/20260727110004_connections_platform_generated_alias.sql',
            'supabase/migrations/20260727110005_connections_idx_unique_active.sql',
            'supabase/migrations/20260727110006_connections_idx_canonical.sql',
            'supabase/migrations/20260727110007_connections_idx_user_surface_sort.sql',
