...
class BioMentionChainsJob implements ShouldBeUnique, ShouldQueue
{
    ...
    {
        try {
            $this->run($scraper, $linker, $router, $discovery, $user, $this, $user, $user, $this, $this, $user, $this, $this, $this, $this, $this, $mentions, $this, $mentions, $connection, $user, $mentions, $connection, $mentions, $this, $user, $user, $user, $mentions, $m, $m, $m, $mentions, $m, $m, $m, $mentions, $this, $mentions, $scrapes, $workplaceDone, $mentions, $mention, $scrapes, $handle, $mention, $type, $mention, $handle, $type, $type, $workplaceDone, $this, $user, $handleName, $handle, $oneHop, $linker, $user, $handleName, $this, $handle, $handleName, $oneHop, $oneHop, $oneHop, $workplaceDone, $oneHop, $profile, $this, $scraper, $handle, $scrapes, $profile, $venue, $this, $profile, $handle, $venue, $handleName, $candidateName, $attemptVenue, $candidateName, $venue, $outcome, $linker, $user, $attemptVenue, $workplaceDone, $outcome, $this, $handle, $candidateName, $outcome, $outcome, $outcome, $profile, $this, $scraper, $handle, $scrapes, $website, $profile, $profile, $website, $website, $result, $router, $user, $website, $this, $handle, $website, $result, $e, $e, $this, $user, $router, $discovery, $user, $router, $discovery);
        } finally {
