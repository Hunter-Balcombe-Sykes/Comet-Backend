...
- display_name: the person's or act's clean public name. Derive it FIRST from the username/handle when the handle reads as a name (e.g. "simondoylehair" → "Simon Doyle"); otherwise clean the full name. Strip role descriptors (Barber, Hair, Music, Studio, Educator…), emojis, taglines after | • — and similar separators. Use ONLY words present in the handle or full name — never invent.
