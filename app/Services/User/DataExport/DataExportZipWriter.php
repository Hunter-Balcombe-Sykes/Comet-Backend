...
// revisions and was removed once production paths (ExportUserDataJob)
...
class DataExportZipWriter
{
     ...
     */
    public function writeStreaming(DataExportPayloadBuilder $builder, string $userId): array
    {
        ...
        try {
            ...
            foreach ($builder->stream($userId) as $section) {
                $name = $section['name'];
