...
trait NormalizesMenuData
{
    ...
    /**
     * Title Case for scraped item names. The algorithm lives in
     * ScrapedNameCasing::titleCase() — this stays as the drivers' named seam
     * (and the trait's test surface) rather than a second copy of it.
     */
    private function titleCase(?string $s): ?string
    {
        return ScrapedNameCasing::titleCase($s);
    }
