...
- [ ] **Worker-kill drill** — run `docs/runbooks/drills/01-worker-kill.md` (LOCAL stack only); log to `docs/runbooks/drills/logs/`. Freshness auto-checked by group F.
- [ ] **Vendor-outage drill** — run `docs/runbooks/drills/02-vendor-outage.md` (local); log as above. Freshness auto-checked by group F.
- [ ] **Redis-down drill** — run `docs/runbooks/drills/03-redis-down.md` (local); log as above. Freshness auto-checked by group F.
...
- [ ] **PITR / backups** — confirm plan tier supports PITR; run the restore drill `docs/runbooks/drills/04-backup-restore.md` (to a scratch project, never a live one); log as above. Quarterly thereafter — freshness auto-checked by group F.
