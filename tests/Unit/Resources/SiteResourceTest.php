...
it('ships only the allowlisted columns and passes non-design settings through', function () {
    ...
    expect(array_keys($array))->toEqual([
        'id', 'user_id', 'subdomain', 'is_published', 'architecture_id',
    ...
    // Back on the wire 2026-08-24 (reopens the 2026-08-20 lockdown) — the
    // dashboard's Site page needs it back to show the current selection.
