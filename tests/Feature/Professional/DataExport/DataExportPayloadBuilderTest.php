...
it('exports owned, global, AND cross-professional email_subscriptions for the user (P1-15)', function () {
    ...
    DB::connection('pgsql')->table('notifications.email_subscriptions')->insert([
        // Owned row — joined by professional_id.
        [
            'id' => (string) Str::uuid(),
        ...
        // Global "sidest_updates" row — professional_id IS NULL, keyed by email_lc only.
        [
            'id' => (string) Str::uuid(),
        ...
        // Row is keyed to a different professional_id but contains Jane's email
...
it('exports notifications.messages and notifications.receipts addressed to the user', function () {
    ...
    DB::connection('pgsql')->table('notifications.notifications')->insert([
        ...
        // Broadcast (NULL professional_id) — not user-specific, excluded.
        [
            'id' => (string) Str::uuid(),
            'professional_id' => null,
            'type' => 'Info',
...
it('exports handle_aliases and subdomain_aliases for the user', function () {
    ...
    DB::connection('pgsql')->table('site.sites')->insert([
        ['id' => $siteId, 'professional_id' => $pro->id, 'subdomain' => 'jane', 'created_at' => '2026-01-01T00:00:00Z'],
...
it('exports professional_confirmation_preferences for the user', function () {
    $pro = seedProForPayload((string) Str::uuid());

    DB::connection('pgsql')->table('core.professional_confirmation_preferences')->insert([
        [
            'id' => (string) Str::uuid(),
            'professional_id' => $pro->id,
