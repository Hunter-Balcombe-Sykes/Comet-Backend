...
/**
 * SEC-2 — UserSectionBlockController's write endpoints (upsert/remove)
 ...
 *
 * AUDIT-2026-08-05: reorder() was removed with the dead POST /sections/reorder
 * route (dashboard never called it); its pending-deletion case is removed
 * alongside it.
 */
