...
//
// Strategy mirrors tests/Feature/Security/ModerationSchemaRlsTest.php: introspect
// pg_class (PostgreSQL-only) rather than exercising RLS, which SQLite cannot
// enforce. Skips on the default SQLite test driver.
//
// To run against a Supabase dev DB:
//   DB_CONNECTION=pgsql DB_HOST=... phpunit --filter AnalyticsSessionsRlsTest

use Illuminate\Support\Facades\DB;

function analyticsRlsIsPostgres(): bool
{
