-- Serves replaceCollections()' origin-scoped DELETE on content.item_tags
...
-- ROLLBACK: DROP INDEX CONCURRENTLY IF EXISTS "content"."idx_item_tags_origin";
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_item_tags_origin" ON "content"."item_tags" ("item_id", "source_item_id");
