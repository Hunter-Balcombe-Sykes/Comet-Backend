-- Serves replaceCollections()' origin-scoped DELETE on content.item_variants
...
-- ROLLBACK: DROP INDEX CONCURRENTLY IF EXISTS "content"."idx_item_variants_origin";
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_item_variants_origin" ON "content"."item_variants" ("item_id", "source_item_id");
