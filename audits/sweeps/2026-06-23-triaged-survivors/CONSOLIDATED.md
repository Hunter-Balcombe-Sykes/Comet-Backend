...
- Standalone: 19 / 26 complete (PRIV-4, SEC-1, PRIV-2, DINT-1, PRIV-7, PRIV-8, DINT-6 + schema batch DINT-2,3,7,8,10,11 SCHEMA-2,7 + MIG-2/5/6 resolved-by-convention + P3-11 obsolete) · 2 deferred (CCH-2, PRIV-3) · schema migrations pending `supabase db push`
